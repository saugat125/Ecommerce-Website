...
if (isset($_POST['disable'])) {
    ...
    $disable_query = "UPDATE TRADER SET ISVERIFIED = '$is_verified' WHERE user_id = '$user_id'";
...
if (isset($_POST['enable'])) {
    ...
    $enable_query = "UPDATE TRADER SET ISVERIFIED = '$is_verified' WHERE user_id = '$user_id'";
...
<body>
    ...
    <div class="flex-page">
        ...
        <main>
            <h1 style="font-size:20px;margin-bottom:20px;">TRADERS</h1>
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        <?php
                        $query = "
                            SELECT u.email, u.first_name, u.last_name, u.phone_number, c.date_joined, c.isverified, c.user_id, s.shop_name
                            FROM USERS u
                            INNER JOIN TRADER c ON u.user_id = c.user_id
                            LEFT JOIN SHOP s ON c.user_id = s.trader_id";
